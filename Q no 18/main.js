...
//
var travel = ["makkah", "madina", "taif", "jabalenoor", "riyaz", "jaddah"];
//orignal array
console.log(travel);
// print alphebatical array
console.log(travel.slice().sort());
//no change orignal array
console.log(travel);
//.sort sy accending order main array ay ga
travel.sort();
console.log(travel);
//.sort a b =>b.localcompare(a)deassending hoga
travel.sort(function (a, b) { return b.localeCompare(a); });
console.log(travel);
console.log(travel);
